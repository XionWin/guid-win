...
public delegate void RenderTrianglesHandler(object uptr,ref NVGpaint paint,ref NVGscissor scissor, NVGvertex[] verts,int nverts);
...
{
    public const float NVG_PI = (float)Math.PI;
